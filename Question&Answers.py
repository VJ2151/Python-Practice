...
for i in range(1,len(d)):
    if d[i-1]==d[i]:
        ...
        result += d[i-1] + str(count)
        count = 1
result+= d[-1]+str(count)
print(result)
# -----------------------------------------------------------------------------------------------------------------------------------------------------------------
SORT AN ARRAY:
l = [12,39,47,27,30,74,8,64,40]
...
# -----------------------------------------------------------------------------------------------------------------------------------------------------------------
finding PRIME AND NOTPRIME
l = [12,39,47,27,30,74,8,89,64,40]
for j in l:   
    num = "Prime"
    for i in range(2, j):
        if j % i == 0:   # if divisible by any number → Not Prime
            num = "Not Prime"
            break
    print(j, num)

# -----------------------------------------------------------------------------------------------------------------------------------------------------------------
# 11. Given array [80, 60, 10, 50, 30, 100, 0, 50], find pairs whose sum = 100, logic, complexity, and better solution.

l = [80, 60, 10, 50, 90 , 70 , 30, 100, 0, 50]
